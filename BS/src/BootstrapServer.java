                        ...
                        for (int i=0; i<nodes.size(); i++) {
                            if (nodes.get(i).getPort() == port) {
                                if (nodes.get(i).getUsername().equals(username)) {
                                    reply += "9998";
                                    isOkay = false; // TODO: remove after test
                                } 
                                else
                                {
                                    //reply += "9997"; // TODO: Uncomment after test
                                	isOkay = true; // // TODO: remove after test
                                }
                                
                                //isOkay = false;// TODO: Uncomment after test
                            }
                        }
                        if (isOkay) {
                            if (nodes.size() == 1) {
                                ...
                                reply += "2 " + nodes.get(0).getIp() + " " + nodes.get(0).getPort()+ " " + nodes.get(0).getUsername()+ " " + nodes.get(1).getIp() + " " + nodes.get(1).getPort()+ " " + nodes.get(1).getUsername();
                            } else {
                                Random r = new Random();
                                int Low = 0;
                                int High = nodes.size();
                                ...
                                reply += "2 " + nodes.get(random_1).getIp() + " " + nodes.get(random_1).getPort()+ " " + nodes.get(random_1).getUsername() + " " + nodes.get(random_2).getIp() + " " + nodes.get(random_2).getPort() + " " + nodes.get(random_2).getUsername();
                            }
                            nodes.add(new Neighbour(ip, port, username));
                        }
                    }
